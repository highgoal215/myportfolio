    ...
    <section id="experience">
      ...
      <div className=" container mx-auto 2xl ">
        ...
        <p className="text-gray-300 pt-5">
          ...
          <br />
          - Assisted in developing the backend that became the foundation for
          the intersection between Web3 and FinTech
          <br />- Participated in 5+ open source community projects, met with
